...
uploaded_files = st.file_uploader(
    "Tải Ảnh/PDF SGK, CV hướng dẫn (5512, 7991,2345,...), ...  (Kéo thả vào đây):", 
    ...
    if not api_key: st.toast("Thiếu API Key!", icon="❌")
        ...
        try:
            with st.spinner('AI đang soạn giáo án (Times New Roman 14pt, A4, Căn lề chuẩn)...'):
                ...
                Đóng vai là một Giáo viên giỏi bậc Trung học phổ thông, am hiểu chương trình GDPT 2018.
                ...
                * Nội dung tích hợp (VD: Học thông qua chơi, Công dân số,...)
                ...
                - Mỗi Bài soạn có thể có nhiều tiết, do đó cần CHIA TIẾT cho hợp lý (THEO YÊU CẦU CỦA NGƯỜI DÙNG nhập vào ở biến 'so_tiet'). Mỗi tiết học chỉ có 42 phút, hãy điều chỉnh lượng kiến thức và hoạt động hợp lý. 
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2026 - Nguyễn Công Tĩnh - Trường THPT Chuyên Hà Giang - ĐT: 0913.256.001</div>", unsafe_allow_html=True)
